				...
				<div class="box-body">
					<div class="nav-tabs-custom">
						<ul class="nav nav-tabs">
							<li class="active"><a href="#t1" data-toggle="tab" >Tipo de Contrato</a></li>
							<li><a href="#t2" data-toggle="tab">Tipos de Documentos Asociados</a></li>
						</ul>
						<div class="tab-content">
							<div class="tab-pane active" id="t1">
								{!! Form::model($model, ['route' => ['tipos-contratos.update', $model->id], 'method' => 'PATCH', 'class' => 'form-horizontal']) !!}
									{{ Form::fhText('id', null, null, false, 4, $model->id, ['readonly' => true]) }}
									{{ Form::fhText('nombre', null, null, true) }}
									{{ Form::fhTextarea('notas') }}
									{{ Form::fhCheck('nivel_subcontratas', '¿Vigilar nivel de subcontratas?', false, $model->nivel_subcontratas) }}
...
@push('scripts')
<script src="{{ asset('/js/modal-form-submit.js') }}"></script>
...
$(function() {
	$.STD().init(
		...
		'documentos-table',
		'{!! route('tipos-contratos.tiposDocumentosData') !!}',
